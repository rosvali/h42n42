...
(function
  (globalThis){
   ...
   function to_array(s){
    ...
    return caml_call2(Stdlib_Array[2], caml_ml_string_length(s), _o_);
   }
   function cut(s, on){
